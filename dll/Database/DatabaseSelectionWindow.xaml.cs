...
namespace ssi
{
    ...
    public partial class DatabaseSelectionWindow : Window
    {
        ...
        public DatabaseSelectionWindow(List<string> strings, bool showadminbuttons, string title = "Select", string Collection = "none", AnnoType isDiscrete = AnnoType.DISCRETE, bool scheme = false, AnnoTrack _a = null)
        {
            InitializeComponent();
